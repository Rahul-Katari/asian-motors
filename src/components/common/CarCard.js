...
const CarCard = () => {
    return (
      <div className="box-car car-block-three col-lg-3 col-md-6 col-sm-12">
        <div className="inner-box">
          ...
          <div className="content-box">
            <h6 className="title">
              <a href="car-details.html">Mercedes-Benz, C Class</a>
            </h6>
            <div className="text">2023 C300e AMG Line Night Ed Premiu...</div>
            <ul>
              <li>
                <i className="flaticon-gasoline-pump"></i>72,925 miles
              </li>
              <li>
                <i className="flaticon-speedometer"></i>Petrol
              </li>
              <li>
