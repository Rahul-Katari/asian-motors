                    ...
                    <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div className="inner-box wow fadeInUp">
                            <div className="icon-box">
                                ...
                                <path d="M30 2.34375V7.03125" stroke="#FF5CF4" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M48.75 2.34375L44.0625 7.03125" stroke="#FF5CF4" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                ...
                                <path d="M11.25 2.34375L15.9375 7.03125" stroke="#FF5CF4" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M17.3849 29.5312H42.6151" stroke="#eb5e21" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M25.3125 24.8438L30 29.5312L34.6875 24.8438" stroke="#eb5e21" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M30 43.5938V29.7306" stroke="#eb5e21" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            <div className="content-box">
                    ...
                    <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div className="inner-box wow fadeInUp">
                            <div className="icon-box">
                                ...
                                <path d="M16.9749 38.3378L20.2894 35.0232" stroke="#eb5e21" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M33.5476 21.765L36.8621 18.4504" stroke="#eb5e21" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                <path d="M43.5938 57.6562L57.6563 43.5937" stroke="#FF5CF4" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                </g>
                                <defs>
                    ...
                    <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
                        <div className="inner-box wow fadeInUp">
                            <div className="icon-box">
                                ...
                                <path d="M57.6562 41.6016C57.6562 46.0997 54.0098 49.8047 49.5117 49.8047C45.0136 49.8047 41.3672 46.1583 41.3672 41.6602C41.3672 37.162 45.0722 33.5156 49.5703 33.5156M43.5352 48.1055L36.0938 55.5469" stroke="#FF5CF3" strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            <div className="content-box">
